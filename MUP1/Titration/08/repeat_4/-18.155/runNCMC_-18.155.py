...
ref_atoms = [{'name': 'CA', 'resname': 'PHE', 'resid': '57'},
...
ncmc_mover = grand.samplers.NonequilibriumGCMCSphereSampler(system=system, topology=pdb.topology,
                                                            ...
                                                            adams=adams_value, standardVolume=volume_per_lig,
                                                            referenceAtoms=ref_atoms, sphereRadius=sphere_rad,
                                                            nPertSteps=n_pert, nPropStepsPerPert=n_prop, timeStep=dt,
                                                            resname='L02',
                                                            ghostFile='ncmc-ghost-ligs.txt', log='MUP1NCMC.log',
                                                            rst="checkpoint.rst7",
                                                            dcd='MUP1NCMCholo_raw.dcd', overwrite=True, recordTraj=False, maxN=1)

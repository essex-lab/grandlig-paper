...
ncmc_mover = grand.samplers.NonequilibriumGCMCSphereSampler(system=system, topology=pdb.topology, temperature=298*kelvin, integrator=integrator, excessChemicalPotential=None, adams= -12.623775607148328, standardVolume=None, referenceAtoms=ref_atoms, sphereRadius=sphere_rad, nPertSteps=1499, nPropStepsPerPert=50, resname='LIG', ghostFile='ncmc-ghost-ligs.txt', log='T4L99A.log', dcd='T4L99A_raw.dcd', overwrite=True, maxN=99, recordTraj=False) 

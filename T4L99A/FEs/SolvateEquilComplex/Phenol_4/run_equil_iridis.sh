...
/scratch/wp1g16/miniconda3/envs/OMM8.0/bin/python $SCRIPT_FOLDER/solvate_equilibrate.py --pdb ../../GettingRestraintParameters/Phenol_4/ClosestRestraintFrame.pdb --xml ../../GettingRestraintParameters/Phenol_4/*.xml  -a 2646 2647 2648 1531 1520 1519 -ref 0.659 75.317 153.414 -78.750 -157.318 -92.127  

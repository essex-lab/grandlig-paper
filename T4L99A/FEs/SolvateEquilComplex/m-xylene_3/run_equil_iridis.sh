...
/scratch/wp1g16/miniconda3/envs/OMM8.0/bin/python $SCRIPT_FOLDER/solvate_equilibrate.py --pdb ../../GettingRestraintParameters/m-xylene_3/ClosestRestraintFrame.pdb --xml ../../GettingRestraintParameters/m-xylene_3/*.xml  -a 2647 2646 2645 1833 1830 1829 -ref 0.570 87.588 81.756 84.339 -140.762 -94.379  

...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Restraint_free_energy1Lig.py -p ../../../../SolvateEquilComplex/o-xylene_4/FinalEquiled_simulationtop.pdb -x ../../../../GettingRestraintParameters/o-xylene_4/*.xml  -a 2649 2650 2645 1564 1556 1555 -ref 0.524 100.348 120.265 92.970 130.490 -147.988   -lam $LAMBDA

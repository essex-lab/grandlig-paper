...
/scratch/wp1g16/miniconda3/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Restraint_free_energy1Lig.py -p ../../../../SolvateEquilComplex/Phenol_1/FinalEquiled.pdb -x ../../../../GettingRestraintParameters/Phenol_1/*.xml  -a 2649 2648 2647 1568 1565 1564 -ref 0.384 80.699 90.877 65.072 171.083 -122.660   -lam $LAMBDA

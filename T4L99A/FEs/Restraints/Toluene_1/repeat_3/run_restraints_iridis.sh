...
/scratch/wp1g16/miniconda3/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Restraint_free_energy1Lig.py -p ../../../../SolvateEquilComplex/Toluene_1/FinalEquiled.pdb -x ../../../../GettingRestraintParameters/Toluene_1/*.xml  -a 2647 2646 2645 1564 1556 1555 -ref 0.560 96.769 123.004 86.401 147.143 -142.717   -lam $LAMBDA

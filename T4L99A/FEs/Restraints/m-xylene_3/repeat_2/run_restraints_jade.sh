...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Restraint_free_energy1Lig.py -p ../../../../SolvateEquilComplex/m-xylene_3/FinalEquiled_simulationtop.pdb -x ../../../../GettingRestraintParameters/m-xylene_3/*.xml  -a 2647 2646 2645 1833 1830 1829 -ref 0.570 87.588 81.756 84.339 -140.762 -94.379   -lam $LAMBDA

...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Restraint_free_energy1Lig.py -p ../../Propylstartingframe.pdb -x ../../../../GettingRestraintParameters/Propylbenzene/*.xml -a 1835 1834 1836 2648 2651 2647 -lam $LAMBDA

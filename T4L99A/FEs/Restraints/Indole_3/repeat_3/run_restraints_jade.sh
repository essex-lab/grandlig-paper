...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Restraint_free_energy1Lig.py -p ../../../../SolvateEquilComplex/Indole_3/FinalEquiled_simulationtop.pdb -x ../../../../GettingRestraintParameters/Indole_3/*.xml  -a 2649 2648 2647 1564 1556 1555 -ref 0.497 98.357 117.487 93.581 125.594 -152.428   -lam $LAMBDA

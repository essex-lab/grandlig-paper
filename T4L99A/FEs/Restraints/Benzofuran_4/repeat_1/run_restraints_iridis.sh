...
/scratch/wp1g16/miniconda3/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Restraint_free_energy1Lig.py -p ../../../../SolvateEquilComplex/Benzofuran_4/FinalEquiled.pdb -x ../../../../GettingRestraintParameters/Benzofuran_4/*.xml  -a 2649 2648 2647 1564 1556 1555 -ref 0.495 94.161 120.978 -102.423 -116.485 -153.607   -lam $LAMBDA

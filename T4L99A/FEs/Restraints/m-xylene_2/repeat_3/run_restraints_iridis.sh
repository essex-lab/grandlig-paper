...
/scratch/wp1g16/miniconda3/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Restraint_free_energy1Lig.py -p ../../../../SolvateEquilComplex/m-xylene_2/FinalEquiled.pdb -x ../../../../GettingRestraintParameters/m-xylene_2/*.xml  -a 2648 2647 2646 1565 1564 1556 -ref 0.474 72.349 125.500 57.017 144.752 114.320   -lam $LAMBDA

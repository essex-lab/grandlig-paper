...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Complex_free_energy.py -p ../../../../Restraints/m-xylene_2/repeat_3/lambda_14/FinalFrame.pdb -x ../../../../GettingRestraintParameters/m-xylene_2/*.xml  -a 2648 2647 2646 1565 1564 1556 -ref 0.474 72.349 125.500 57.017 144.752 114.320   -lam $LAMBDA

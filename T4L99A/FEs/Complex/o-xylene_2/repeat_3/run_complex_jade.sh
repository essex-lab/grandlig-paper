...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Complex_free_energy.py -p ../../../../Restraints/o-xylene_2/repeat_3/lambda_14/FinalFrame.pdb -x ../../../../GettingRestraintParameters/o-xylene_2/*.xml  -a 2645 2650 2649 1565 1564 1556 -ref 0.458 69.423 118.709 59.646 159.622 118.093   -lam $LAMBDA

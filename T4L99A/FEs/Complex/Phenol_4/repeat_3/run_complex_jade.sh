...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Complex_free_energy.py -p ../../../../Restraints/Phenol_4/repeat_3/lambda_14/FinalFrame.pdb -x ../../../../GettingRestraintParameters/Phenol_4/*.xml  -a 2646 2647 2648 1531 1520 1519 -ref 0.659 75.317 153.414 -78.750 -157.318 -92.127   -lam $LAMBDA

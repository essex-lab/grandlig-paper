...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Complex_free_energy.py -p ../../../../Restraints/Indene_0/repeat_3/lambda_14/FinalFrame.pdb -x ../../../../GettingRestraintParameters/Indene_0/*.xml  -a 2645 2646 2647 1566 1565 1564 -ref 0.546 101.285 54.269 45.932 119.855 -175.285   -lam $LAMBDA

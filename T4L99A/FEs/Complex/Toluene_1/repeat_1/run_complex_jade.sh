...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Complex_free_energy.py -p ../../../../Restraints/Toluene_1/repeat_1/lambda_14/FinalFrame.pdb -x ../../../../GettingRestraintParameters/Toluene_1/*.xml  -a 2647 2646 2645 1564 1556 1555 -ref 0.560 96.769 123.004 86.401 147.143 -142.717   -lam $LAMBDA

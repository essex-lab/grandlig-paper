...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Complex_free_energy.py -p ../../../../Restraints/o-xylene_4/repeat_1/lambda_14/FinalFrame.pdb -x ../../../../GettingRestraintParameters/o-xylene_4/*.xml  -a 2649 2650 2645 1564 1556 1555 -ref 0.524 100.348 120.265 92.970 130.490 -147.988   -lam $LAMBDA

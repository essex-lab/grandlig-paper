...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Complex_free_energy.py -p ../../../../Restraints/Benzofuran_4/repeat_2/lambda_14/FinalFrame.pdb -x ../../../../GettingRestraintParameters/Benzofuran_4/*.xml  -a 2649 2648 2647 1564 1556 1555 -ref 0.495 94.161 120.978 -102.423 -116.485 -153.607   -lam $LAMBDA

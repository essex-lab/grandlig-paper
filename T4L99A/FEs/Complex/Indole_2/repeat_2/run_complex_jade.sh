...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Complex_free_energy.py -p ../../../../Restraints/Indole_2/repeat_2/lambda_14/FinalFrame.pdb -x ../../../../GettingRestraintParameters/Indole_2/*.xml  -a 2646 2647 2648 1564 1556 1555 -ref 0.518 99.400 119.815 100.625 109.977 -150.813   -lam $LAMBDA

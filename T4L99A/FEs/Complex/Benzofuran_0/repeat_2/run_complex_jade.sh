...
~/.conda/envs/OMM8.0/bin/python $SCRIPT_FOLDER/Complex_free_energy.py -p ../../../../Restraints/Benzofuran_0/repeat_2/lambda_14/FinalFrame.pdb -x ../../../../GettingRestraintParameters/Benzofuran_0/*.xml  -a 2649 2648 2647 1564 1556 1555 -ref 0.559 81.825 137.742 -69.511 51.320 -131.852   -lam $LAMBDA

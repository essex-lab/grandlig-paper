...
ncmc_mover = grand.samplers.NonequilibriumGCMCSphereSampler(system=system, topology=pdb.topology, temperature=298*kelvin, integrator=integrator, excessChemicalPotential=None, adams= -14.439, standardVolume=None, referenceAtoms=ref_atoms, sphereRadius=sphere_rad, nPertSteps=1499, nPropStepsPerPert=50, resname='L02', ghostFile='ncmc-ghost-ligs.txt', log='betaCD.log', dcd='betaCD_raw.dcd', overwrite=True, maxN=1, recordTraj=False) 

...
start = time.time()
PERIOD_OF_TIME = 214200  # 59.5 * 60 * 60
...
mu_ex = -4.486 * kilocalories_per_mole  # From 0.1M simulation
volume_per_lig = 16312.7488 * angstroms**3  # 0.1 M
n_pert = 499
n_prop = 50

wat_mu_ex = -6.09 * kilocalories_per_mole
wat_vol = 30.5625 * angstroms**3  # From 0.1M Ligand equil
n_pert_wat = 99
n_prop_wat = 50
...
simulation.context.setVelocities(rst7.getVelocities())  # From checkpoint

...
# Input Files
pdb = PDBFile('0.5M_equiled.pdb')  # Could be an arg_parser
lig_pdb = glob.glob('../*Pyr*.pdb')
lig_xml = glob.glob('../*Pyr*.xml')
...
# GCNCMC params
mu_ex = -4.486 * kilocalories_per_mole # From 1M simulation
volume_per_lig = 16312.7488 * angstroms**3  # 0.93 M
n_pert = 499
n_prop = 50

wat_mu_ex = -6.09 * kilocalories_per_mole
wat_vol = 30.5625 * angstroms**3  # From 1M Ligand equil
n_pert_wat = 99
n_prop_wat = 50
...
pdb.topology, pdb.positions, wat_ghosts = grand.utils.add_ghosts(pdb.topology,
                                                                 pdb.positions,
                                                                 n=150,
                                                                 pdb='sol-ghosts.pdb')
...
ncmc_mover = grand.samplers.NonequilibriumGCMCSystemSampler(system=system, topology=pdb.topology,
                                                            ...
                                                            ghostFile='ncmc-ghost-ligs.txt', log='bulk_conc_0.1.log',
                                                            rst='checkpoint.rst7',
                                                            dcd='bulkconc_raw.dcd', overwrite=True)
